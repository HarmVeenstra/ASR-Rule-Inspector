...
try {
    ...
    # Fixed this section to properly handle both regular and duplicate per-rule exclusions
    $ASRPerRuleExclusionsData = Get-ASRPerRuleStatusExclusions
    $ASRPerRuleExclusions = $ASRPerRuleExclusionsData.ASRExclusionsReport
    $DuplicateASRPerRuleExclusions = $ASRPerRuleExclusionsData.SameExclusionsReport
...
New-HTMLReport -ASRRules $ASRData -DuplicateASRRules $DuplicateASRRules -ASRExclusions $ASRExclusions -DuplicateASRExclusions $DuplicateASRExclusions -CFAStatus $CFAStatus -ASRPerRuleExclusions $ASRPerRuleExclusions -DuplicateASRPerRuleExclusions $DuplicateASRPerRuleExclusions
